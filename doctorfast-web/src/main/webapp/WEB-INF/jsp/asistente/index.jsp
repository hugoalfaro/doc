...
<!DOCTYPE html>
<t:privado>
    <spring:url value="/rest/asistente/obtenerAsistentes" var="consultar" />
    <spring:url value="/rest/asistente/agregarEditar" var="agregarEditar" />
        ...
        <div class="relative">
            <div id="seccion-consultar" class="page-section">
                <div class="container">
                    ...
                    <form:form id="consultarForm" method="post" modelAttribute="asistenteBean" action="${consultar}" >                        
                                ...
                                <div class="modal-content">
                                    <div class="modal-header bg-gray-dark">
                                        ...
                                        <h4 class="modal-title" id="myLargeModalLabel">
                                            <span class="mostrarAgregar">Agregar Asistente</span>
                                            <span class="mostrarEditar hidden">Editar Asistente</span>
                                        </h4>
                                    </div>
                                    <div class="modal-body p-40">
                                        <div id="agregarEditarMensaje"></div>
                                        <form:form id="agregarEditarForm" method="post" modelAttribute="asistenteBean" action="${agregarEditar}" class="form-horizontal">
    ...
    <script type="text/javascript" src="<c:url value="/resources/js/app/asistente.js"/>"></script>
